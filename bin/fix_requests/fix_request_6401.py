...
*.HadGEM3-GC31-HM.coupled*

In all HadGEM3-GC31-HM control-1950 and hist-1950 data change
parent_source_id with HadGEM3-GC31-MM.
"""
import argparse
...
def main():
    ...
    fixes = [
        FileFix.objects.get(name='HadGemMMParentSourceId'),
    ]
