...
HadGEM3-GC31-[MH]H.ice_ORCA12_grid-t.*

In all HadGEM ice data on the ORCA12 t-grid fix the coordinates and mask.
"""
import argparse
...
def main():
    ...
    fixes = [
        FileFix.objects.get(name='FixCiceCoords12T'),
        FileFix.objects.get(name='FixMaskCICEOrca12T')
    ]
