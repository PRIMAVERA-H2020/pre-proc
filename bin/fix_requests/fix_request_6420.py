...
MOHC.coupled.SImon.sistr[xy]ubot

SistrxubotStandardNameAdd and SistryubotStandardNameAdd
"""
import argparse
...
def main():
    ...
    data_reqs = DataRequest.objects.filter(
        ...
        table_id='SImon',
        cmor_name='sistrxubot'
    )

    fixes = [
        FileFix.objects.get(name='SistrxubotStandardNameAdd'),
    ]
    ...
    data_reqs = DataRequest.objects.filter(
        institution_id__name__in=['MOHC', 'NERC'],
        table_id='SImon',
        cmor_name='sistryubot'
    )

    fixes = [
        FileFix.objects.get(name='SistryubotStandardNameAdd'),
    ]
