...
EC-Earth-Consortium.*.highresSST-present.r1i1p1f1.height2m

Add a height2m dimension to those variables that require it.
"""
import argparse
...
def main():
    ...
    data_reqs = DataRequest.objects.filter(
        ...
        cmor_name__in=['tas', 'tasmin', 'tasmax', 'hurs', 'hursmin', 'hursmax',
                       'huss']
    )
