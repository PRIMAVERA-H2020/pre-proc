...
CMCC.CMCC-CM2-*.highresSST-present

Convert the further_info_url attribute on all CMCC data from HTTP to
HTTPS. Update data_specs_version to 01.00.23.

This isn't applied to some datasets that were reuploaded and already produced
at 01.00.23.
"""
import argparse
