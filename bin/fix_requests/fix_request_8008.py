...
def main():
    ...
    msftmzmpa = FileFix.objects.get(name='MsftmzmpaStandardNameAdd')
    ...
    for data_req in data_reqs:
        data_req.fixes.add(msftmzmpa)

    logger.debug('FileFix {} added to {} data requests.'.
                 format(msftmzmpa.name, data_reqs.count()))
