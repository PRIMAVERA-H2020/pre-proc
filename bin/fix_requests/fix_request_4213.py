...
EC-Earth-Consortium.*.highresSST-present.r1i1p1f1.day.tslsi

Set the cell_methods "area: time: mean (comment: over land and sea ice)"
"""
import argparse
...
def main():
    ...
    fixes = [
        FileFix.objects.get(name='CellMethodsAreaTimeMeanAddLand')
    ]
