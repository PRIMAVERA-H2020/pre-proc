...
MOHC.ocean_ORCA025_grid-u_surface.*

In all MOHC ocean data on the ORCA025 u-grid fix the mask and grid.
"""
import argparse
...
def main():
    ...
    fixes = [
        FileFix.objects.get(name='FixMaskOrca025USurface'),
        FileFix.objects.get(name='FixGridOrca025U')
    ]
