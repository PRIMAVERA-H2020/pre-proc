...
MOHC.ocean_ORCA025_grid-t_surface.*

In all MOHC ocean data on the ORCA025 t-grid fix the mask and grid.
"""
import argparse
...
def main():
    ...
    fixes = [
        FileFix.objects.get(name='FixMaskOrca025TSurface'),
        FileFix.objects.get(name='FixGridOrca025T')
    ]
