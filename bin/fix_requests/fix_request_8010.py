...
def main():
    ...
    siflfwbot = FileFix.objects.get(name='SiflfwbotStandardNameAdd')
    ...
    for data_req in data_reqs:
        data_req.fixes.add(siflfwbot)

    logger.debug('FileFix {} added to {} data requests.'.
                 format(siflfwbot.name, data_reqs.count()))
