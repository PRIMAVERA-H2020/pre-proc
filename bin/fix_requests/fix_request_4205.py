...
EC-Earth-Consortium.*.highresSST-present.r1i1p1f1.*.var_plus_number

Rename the variable itself and the variable_id global attribute.
"""
import argparse
...
def main():
    ...
    sixhrplevpt = DataRequest.objects.filter(
        ...
        variant_label='r1i1p1f1',
        table_id='6hrPlevPt',
        cmor_name__in=['hus7h', 'ta7h', 'ua7h', 'va7h', 'zg27']
    )
