# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-07 15:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('table_id', models.CharField(max_length=50, verbose_name='CMOR variable name')),
        ...
        migrations.AlterUniqueTogether(
            name='datarequest',
            unique_together=set([('institution_id', 'source_id', 'experiment_id', 'table_id', 'cmor_name')]),
        ),
    ]
